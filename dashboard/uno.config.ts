...
export default defineConfig({
  ...
  shortcuts: {
    ...
    "btn-primary": "bg-brand-accent hover:bg-brand-accent/90 text-white font-medium py-2 px-4 rounded-lg transition-all duration-150 active:scale-97 cursor-pointer border-none flex items-center justify-center gap-2",
    ...
    "input-field": "w-full bg-white/5 border border-white/10 rounded-lg py-2 px-3 text-white placeholder-white/30 focus:outline-none focus:border-brand-accent focus:ring-1 focus:ring-brand-accent transition-all",
  },
  theme: {
    colors: {
      brand: {
